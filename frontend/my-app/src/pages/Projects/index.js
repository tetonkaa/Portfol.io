...
export default function Projects(){
    ...
    const projectGrid = ProjectsData.map((project) => (
        <div className="projectMap" >
            ...
            <img className='projectPics' src={project.image} alt={project.name} />
            <br />
            <p className="projectDescription">{project.description}</p>
            <a className="atag" target="_blank" rel="noreferrer" href={project.git}>
                <svg className="projectIcon" viewBox="0 0 128 128">
            ...
            <a  className="atag" target="_blank" rel="noreferrer" href={project.live}>
                <svg  className="projectIcon" viewBox="0 0 128 128">
